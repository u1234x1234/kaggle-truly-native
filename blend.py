...
y19 = pd.read_csv('joint_v124.csv')#v124
y20 = pd.read_csv('joint_v125.csv')#v125
...
y1['sponsored'] = (y20['sponsored'] + y18['sponsored'] + y16['sponsored'] + y15['sponsored'] + y14['sponsored'] + y13['sponsored'] + y1['sponsored'] + y12['sponsored']) / 8

#y1.to_csv('sub_3.csv', index=False)
y1['sponsored'] = inv_logit(logit(a1['sponsored'].values) * 0.4 + logit(y1['sponsored'].values )* 0.4 + 
logit(y16['sponsored'].values )* 0.3 + 0.2*logit(y19['sponsored'].values ))
